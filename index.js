...
function printStrings(array) {
  ...
  let joinedString = array.toString();
  let repeatedString = joinedString + joinedString;
...
function concatenateStrings(array, subString) {
  ...
  if (joinedString.includes(subString)) {
    console.log(`Рядок містить підрядок "${subString}".`);
  } else {
    console.log(`Рядок не містить підрядок "${subString}".`);
  }
